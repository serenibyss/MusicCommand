...
const RAW_REQUEST_FLAG = new Flag("raw-req", "q", BOOL_TYPE, "Show the raw request URL without sending a request");
...
ID_FLAG.setHidden();
RAW_REQUEST_FLAG.setHidden();

function commonFlags() {
    return [HELP_FLAG, NO_EMBED_FLAG, RAW_FLAG, ID_FLAG, RAW_REQUEST_FLAG];
}
